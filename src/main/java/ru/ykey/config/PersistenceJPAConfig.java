...
@ComponentScan(basePackages = {"ru.ykey.dao", "ru.ykey.dao.impl"})
public class PersistenceJPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factoryBean.setPackagesToScan("ru.ykey.model");
...
//        hibernateJpaVendorAdapter.setDatabasePlatform(MySQL5InnoDBDialect.class.getName());
    ...
    public Map<String, Object> jpaProperties() {
        ...
        props.put("hibernate.ejb.naming_strategy", "ru.ykey.dao.CustomNamingStrategy");
